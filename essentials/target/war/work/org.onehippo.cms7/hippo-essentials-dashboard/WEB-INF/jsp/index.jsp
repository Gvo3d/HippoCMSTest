...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/hippo-theme/dist/css/main.css?v=3.1.0"/>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/angular-ui-tree/dist/angular-ui-tree.min.css?v=3.1.0"/>
  <script type="application/javascript">
    window.SERVER_URL = '<%=request.getServerName()+':'+request.getServerPort()%>';
  </script>
  <script src="${pageContext.request.contextPath}/components/jquery/dist/jquery.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/components/angular/angular.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/components/chosen-npm/public/chosen.jquery.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/components/angular-chosen-localytics/dist/angular-chosen.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/components/angular-ui-bootstrap/ui-bootstrap-tpls.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/components/angular-ui-router/release/angular-ui-router.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/components/angular-sanitize/angular-sanitize.js?v=3.1.0"></script>

  <%-- HIPPO THEME DEPS --%>
  <script src="${pageContext.request.contextPath}/components/angular-aria/angular-aria.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/components/angular-animate/angular-animate.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/js/lib/angular-ui-tree.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/components/google-code-prettify/src/prettify.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/components/hippo-theme/dist/js/main.js?v=3.1.0"></script>

  <%-- ESSENTIALS --%>
  <script src="${pageContext.request.contextPath}/js/Essentials.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/js/app.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/js/routes.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/js/directives.js?v=3.1.0"></script>
  <script src="${pageContext.request.contextPath}/js/controllers.js?v=3.1.0"></script>

  <link rel="icon" href="${pageContext.request.contextPath}/images/favicon.ico" type="image/x-icon"/>
  <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/favicon.ico" type="image/x-icon"/>
</head>
<body id="container"  ng-cloak>
<div class="hidden" ng-include="'${pageContext.request.contextPath}/components/hippo-theme/dist/images/hippo-icon-sprite.svg?v=3.1.0'"></div>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="${pageContext.request.contextPath}"
         title="version: 3.1.0">Hippo setup</a>
