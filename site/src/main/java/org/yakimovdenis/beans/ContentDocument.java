...
@HippoEssentialsGenerated(internalName = "HippoCMSTest:contentdocument")
@Node(jcrType = "HippoCMSTest:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "HippoCMSTest:introduction")
    public String getIntroduction() {
        return getProperty("HippoCMSTest:introduction");
    }
    ...
    @HippoEssentialsGenerated(internalName = "HippoCMSTest:publicationdate")
    public Calendar getPublicationDate() {
        return getProperty("HippoCMSTest:publicationdate");
    }
}
